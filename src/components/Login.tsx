...
const Login = () => {
  ...
  const [loginAttempted, setLoginAttempted] = useState(false); // Track login action
  ...
  // Check authentication state but only redirect if login was attempted
  useEffect(() => {
  ...
  const text =
    'Welcome to Lodgelink, where finding your perfect home is just a click away. Sign in to access your personalized dashboard, manage listings, and stay connected with trusted landlords and tenants.';
  ...
  return (
    <div className="bg-[#0025cc] w-full sm:w-[80%] m-auto rounded-lg mt-5 mb-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 w-full sm:w-[80%] gap-3 m-auto rounded-lg">
        <div
          className="relative rounded-lg pl-10 pr-10 py-5 mt-4 mb-4 bg-cover bg-center object-contain"
          style={{ backgroundImage: "url('/part.jpg')" }}
        >
          <span className="absolute inset-0 z-0"></span>
          <div className="flex items-center justify-start gap-2 mt-7">
            <p>
              <Image src="/logo.png" alt="Lodgelink logo" width={30} height={30} className="" />
            </p>
          ...
          <div className="flex flex-col leading-none mt-15">
            ...
            <h1 className="text-[#0025cc] text-[60px]">
              <b>Welcome!</b>
            </h1>
          </div>
          <div className="mt-7">
            ...
            <button
              className="bg-[#00db00] text-white rounded-lg px-3 py-2 mt-4 cursor-pointer hover:bg-[#00db00]/80"
        ...
        <div
          className="bg-[#9faffa] rounded-lg bg-cover bg-center object-contain mt-4 mb-4"
          ...
          <div className="rounded-lg">
            <form onSubmit={handleEmailLogin} className="mb-4 w-[80%] m-auto py-15">
              ...
              <div className="flex justify-between mt-5">
                ...
                <Link href="/forgotten" className="text-[15px] sm:text-[15px] text-[#ffffff]">
                  Forgotten Password
                </Link>
              </div>
              <button
                type="submit"
                className="cursor-pointer w-full bg-[#697fe1] hover:bg-[#0025cc] transition ease-in-out duration-300 text-white py-2 rounded-lg"
              >
                Login with Email
              </button>
              ...
              <div className="flex items-center gap-3 m-auto">
                ...
                <div className="flex items-center py-2 transition ease-in-out duration-300">
                  <Link href="/register" className="hover:text-[#0025cc] text-[#ffffff] transition duration-300 ease-in-out">
                    Sign Up
                  </Link>
                </div>
              </div>
